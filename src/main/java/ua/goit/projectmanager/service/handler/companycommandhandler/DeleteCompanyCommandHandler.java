...
public class DeleteCompanyCommandHandler extends CommandHandler {


    public DeleteCompanyCommandHandler(CommandHandler handler) {
        super(handler);
    }
    ...
    protected boolean isApplicable(String command, Map<String, Command> commands) {
        return "delete_company".equalsIgnoreCase(command);
    }
}
